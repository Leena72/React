...
class AssignProducts extends Component {
    ...
    render() {
        let {fixedtax,fixedmotor,fixedRateChecked} = this.state;
        console.log("fixedmotor",fixedmotor)
        const fixedRate = this.state.fixedRateChecked
            ? <div className="fixedRate">
                ...
                <div className="form-check tax">
                    <input className="form-check-input" type="radio" name="fixednov" id="exampleRadios2"
                           value="option1"/>
        ...
        const centMile = this.state.centMileChecked
            ...
            <div className="fixedRate">
                <p className="selectRequired">Select Required Forms:</p>
                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="centmileinsurance" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange} disabled checked/>
                    <label className="form-check-label">Insurance Declaration</label>
                </div>
                <p className="requiredCheck">(Required for this product)</p>

                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="centmilevehicle" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange} disabled checked/>
                    <label className="form-check-label">Vehicle Information (BVIF)</label>
                </div>
                <p className="requiredCheck">(Required for this product)</p>
                ...
                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="centmilemotor" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange}/>
                    <label className="form-check-label">Motor Vehicle Records (MVR)</label>
                </div>
            </div>
            : null;
        ...
        const techOnly = this.state.techOnlyChecked
            ...
            <div className="fixedRate">
                <p className="selectRequired">Select Required Forms:</p>
                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="techinsurance" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange} disabled checked/>
                    <label className="form-check-label">Insurance Declaration</label>
                </div>
                <p className="requiredCheck">(Required for this product)</p>
                ...
                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="techvehicle" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange} disabled checked/>
                    <label className="form-check-label">Vehicle Information (BVIF)</label>
                </div>
                <p className="requiredCheck">(Required for this product)</p>
                ...
                <div className="form-check form-check-inline">
                    <input className="form-check-input" name="techmotor" type="checkbox" id="inlineCheckbox1"
                           value="option1" onClick={this.handleChange}/>
                    <label className="form-check-label">Motor Vehicle Records (MVR)</label>
                </div>
            </div>
        ...
        return (
                ...
                <div>
                    <div className="formwrapper">
                        ...
                        <div className="assignProducts">
                            <div className="fixedVariableRate">
                                <div className="form-check form-check-inline">
                                    <input name="fixedRateChecked" className="form-check-input" type="checkbox"
                                           id="inlineCheckbox1" value="option1" onChange={this.handleCheck}/>
                            ...
                            <div className="centmile">
                                <div className="form-check form-check-inline">
                                    <input name="centMileChecked" className="form-check-input" type="checkbox"
                                           id="inlineCheckbox1" value="option1" onChange={this.handleCheck}/>
...

                            {
                                !this.state.centMileChecked || !this.state.fixedRateChecked ?
                                    <div className="techOnly">
                                        <div className="form-check form-check-inline">
                                            <input name="techOnlyChecked" className="form-check-input" type="checkbox"
                                                   id="inlineCheckbox1" value="option1" onChange={this.handleCheck}/>
...

                        {
                            this.state.fixedRateChecked || this.state.centMileChecked ?
                                <div className="paymentMethod">
                                    ...
                                    <p className="paymentContent">Applies to fixed & Variable Rate and Cents Per Mile
                                        products only</p>
                                    <div className="form-check payment">
                                        <input name="fundsChecked" className="form-check-input" type="radio"
                                               value="option2" onChange={this.handleCheck}/>
                                        <label className="form-check-label payment-label">
                                            Direct Deposit
                                        </label>
                                        ...
                                        <div className="concur">
                                            <input name="fundsconcurpayroll" className="form-check-input" type="radio"
                                                   value="option2" onChange={this.handleCheck}/>
                                            <label className="form-check-label payment-label">
                                                Concur
                                            </label>
                        ...
                        <div className="driverManagement">
                            ...
                            <div className="driverManageOptions">
                                <input name="dmOptions" className="form-check-input" type="radio" value="option2"
                        ...
                        {this.state.fixedRateChecked || this.state.centMileChecked ?
                            <div className="fixedPaySchedule">
                                ...
                                <p className="fpContent">Applies to fixed & Variable Rate and Cents Per Mile products
                                    only</p>
                                <div className="fixedPayOptions">
                                    <input name="fpOptions" className="form-check-input" type="radio" value="option2"
                                           onChange={this.handleCheck}/>
                                    <label className="form-check-label payment-label">
                                        Prior Month (Arrears)
                                    </label>
                    ...
                    <div className="buttons">
                        <button type="button" className="btn btn-secondary cancel" variant="primary"
                                onClick={this.props.backStep}><i class="fas fa-arrow-left"></i>  Back 
                        </button>
